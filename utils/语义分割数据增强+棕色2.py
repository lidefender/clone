...
def augment_image(image, mask, n_augmentations=1):
    ...
    transform = A.Compose([
        ...
        # A.RandomCrop(height=640, width=640, p=0.4),  # 随机裁剪到640x640大小，概率为40%
...
if __name__ == "__main__":
    ...
    input_mask_folder = r"F:\work\dataset\rebar2D\train2\label"  # 输入掩码文件夹路径
    ...
    label_format = "json"  # 标签格式，可选"mask"或"json"
